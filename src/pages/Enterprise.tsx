...
const trustedLogos = [
  "TechCorp", "DataFlow", "CloudBase", "NexGen", "Innovate", "ScaleUp"
];

const buildCards = [
  { icon: BarChart3, title: "Internal Dashboards", desc: "Real-time analytics and reporting" },
  { icon: Users, title: "CRM & Sales Tools", desc: "Customer management systems" },
  { icon: DollarSign, title: "Finance & HR Portals", desc: "Employee and payroll systems" },
...
const steps = [
  ...
  { step: "02", title: "Generate", desc: "PerfectCode generates a real full-stack app" },
...
const collaborationFeatures = [
  ...
  { icon: UserCog, title: "Role-Based Access", desc: "Granular permissions control" },
...
const securityFeatures = [
  ...
  { icon: UserCog, title: "Role-Based Permissions", desc: "Fine-grained access control" },
  { icon: Eye, title: "Audit Logs", desc: "Complete activity tracking" },
  { icon: Server, title: "Private Environments", desc: "Isolated infrastructure" },
  { icon: Shield, title: "Data Isolation", desc: "Tenant separation" },
  { icon: Code, title: "Source Code Ownership", desc: "You own 100% of your code" },
];
...
const comparisonData = [
  ...
  { platform: "Bolt", focus: "Developer Productivity", desc: "Code generation tools" },
  { platform: "PerfectCode", focus: "Enterprise Software Production", desc: "Full-stack production apps", highlight: true },
];
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-8">
              ...
              <span className="text-sm text-primary font-medium">Enterprise</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-10 max-w-3xl mx-auto leading-relaxed">
              PerfectCode turns prompts into production-ready applications with full security, governance, and source code ownership.
            </p>
      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {buildCards.map((card) => (
              <Card key={card.title} className="group bg-card/50 border-border/50 hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:shadow-primary/5">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {collaborationFeatures.map((feature) => (
              <Card key={feature.title} className="bg-card/50 border-border/50 hover:border-primary/50 transition-all duration-300 text-center">
                <CardContent className="p-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-muted-foreground mb-8">
                PerfectCode plugs into your existing DevOps — not a closed platform.
              </p>
            ...
            <div className="relative">
              <div className="aspect-square rounded-3xl bg-gradient-to-br from-primary/10 via-card to-accent/10 border border-border/50 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground">Your code, your infrastructure</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <CardContent className="p-10">
                <div className="text-center mb-10">
                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6">
                    ...
                    <span className="text-sm text-primary font-medium">White-Glove Service</span>
                  </div>
                  <h2 className="text-4xl md:text-5xl font-bold mb-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  {supportFeatures.map((feature) => (
                    <div key={feature.title} className="flex items-center gap-3 p-4 rounded-xl bg-background/50">
            ...
            {comparisonData.map((item) => (
              ...
              >
                <CardContent className="p-8 text-center">
                  <h3 className={`text-2xl font-bold mb-2 ${item.highlight ? 'gradient-text' : ''}`}>
                    {item.platform}
                  </h3>
                  <p className="text-lg font-medium text-primary mb-2">{item.focus}</p>
