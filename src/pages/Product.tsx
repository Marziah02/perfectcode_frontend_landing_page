              ...
              <span className="text-foreground font-medium">{item.text}</span>
				...
				<motion.div
					...
					{buildTypes.map((item, index) => (
						<motion.div
							...
							<div className="relative z-10 ">
								<div className="relative w-12 h-12 mb-16">
                  ...
                  /> */}
								...
								<div className="">
									{" "}
									<h3 className="text-2xl font-bold mb-4 text-slate-200 group-hover:text-slate-100 transition-colors">
										{item.title}
									</h3>
									<p className="text-slate-200 group-hover:text-slate-100 leading-relaxed text-sm mb-6 transition-colors">
										{item.description}
									</p>
								</div>
			...
			<div className="container mx-auto px-6">
                ...
                ">
								...
								<div className="pointer-events-none absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition">
									<div className="absolute -inset-0.5 rounded-2xl bg-gradient-to-r from-[#8673E633] via-cyan-400/15 to-[#EB479933] blur-xl" />
								</div>
                    ...
                    ">
										<a.icon className="h-5 w-5 text-[#EB4799]" />
									</div>
